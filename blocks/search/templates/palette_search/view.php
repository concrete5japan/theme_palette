...
?><form action="<?php echo $view->url($resultTargetURL)?>" method="get" class="palette-search ccm-search-block-form"><?php
    ...
    if (isset($buttonText) && ($buttonText !== '')) {
        ?> <button type="submit" class="btn btn-default ccm-search-block-submit"><i class="fa fa-search" aria-hidden="true"></i></button><?php
    }
